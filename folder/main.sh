...
echo -e ""
    ...
    echo -e "      \033[0;36mWhatsapp${NC} wa.me/6285839246692"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
clear
echo -e "${y}────────────────────────────────────────────────${NC}"
echo -e "                ${ungu} DAFFA VPN STORE ${NC}"
echo -e "${y}────────────────────────────────────────────────${NC}"
...
DATEVPS=$(date +'%d-%m-%Y')
CHATID="6225527176"
KEY="7116564718:AAG2D5EXODXucvyE81Tg4qmP-m3SG7PJIm0"
...
<b>DAFFA STORE BOT</b>
<code>────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":" ⛈️ ʙᴜʏ ꜱᴄʀɪᴘᴛ ⛈️ ","url":"https://t.me/Daff_Store75"}]]}' 
...
sleep 2
wget -q -O udp-custom.sh https://raw.githubusercontent.com/zhetsai/udp-custom/master/udp-custom.sh
...
cd /bin
git clone  https://github.com/zhetsai/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
...
REPO3="https://github.com/Daffastorevps/Script/raw/master/folder/"
cd
